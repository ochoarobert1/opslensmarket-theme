<?php
add_action( 'tgmpa_register', 'opslens_register_required_plugins' );
 ...
 */
function opslens_register_required_plugins() {
    /*
     ...
     */
    $config = array(
        'id'           => 'opslens_tgmpa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
